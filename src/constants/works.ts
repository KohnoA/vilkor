...
export const WORKS: IWork[] = [
  ...
  },
  {
    ...
    desc: 'Мы продаем посадочный материал, соответствующий государственным стандартам качества. Уникальная упаковка, созданная специально для пересылки саженцев, позволяет нам отправлять живые корни в любую точку страны.',
    images: [testImg, test2Img],
  },
];
