    ...
    >
      ...
      <div>
        ...
        <ul className={styles.list}>
          <li>
            1 Приусадебный участок. Практически 100% сорняков не может пробиться сквозь толщу
            мульчи. Отдельные поросли со слабой корневой системой легко будут удаляться вручную. Вы
            избавитесь от необходимости быть привязанными к огороду и саду, т.к. значительно
            сократится число поливов. А в дождливую погоду не будете переживать, что растения
            загниют.
          </li>

          <li>
            2 Ландшафтный дизайн. Любая дизайнерская идея так или иначе включает в себя оформление
            различных зон при помощи мульчи из сосны. Последние сразу приобретают красивый ухоженный
            вид и выглядят более выразителтно на фоне коры. Также покрытие применяют для отсыпки
            дорожек, детских площадок, зон отдыха…
          </li>

          <li>
            3 Интерьер. Преимущество мульчи оценили не только ландшафтные дизайнеры. В современных
            квартирах и частных домах все чаще встречаются различные инсталляции из крупных кусков
            коры, в т.ч. ее используют для декоративной отделки стен.
          </li>
        </ul>
      </div>
